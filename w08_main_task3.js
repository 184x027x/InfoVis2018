function main()
{
    ...
    for ( var i = 0; i < nfaces; i++ )
    {
        ...
        var S1 = scalars[ id[1] ];
        var S2 = scalars[ id[2] ];
        var C0 = new THREE.Color().setHex( cmap[ Math.round((S0-0.1)*364) ][1] );
        var C1 = new THREE.Color().setHex( cmap[ Math.round((S1-0.1)*364) ][1] );
        var C2 = new THREE.Color().setHex( cmap[ Math.round((S2-0.1)*364) ][1] );
